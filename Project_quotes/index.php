...
//citati
            ...
            $brojac = count($motivacija);
            $broj3 = $brojac / 2;
            $cit3 = round(rand(0, $broj3 -1));
            $citat3 = $cit3 * 2;
            $autor3 = $citat3 + 1;
        ?>
        ...
        <header id="slajd" class="carousel slide container page-holder bg-cover" data-ride="carousel" > 
        ...
        <section class=" text-light text-center opacity-100 row">
            ...
            <p>
                ...
                $random = rand(1, 4);
                if($random == 1){
                    echo "<h1 class='col-sm-12 col-md-12 col-xl-12'>$posao[$citat1]</h1>";
                    echo "<h3 class='col-sm-12 col-md-12 col-xl-12'>$posao[$autor1]</h3>";
                }
                elseif($random == 2){
                ...
                elseif($random == 3){
                    echo "<h1 class='col-sm-12 col-md-12 col-xl-12'>$ljubav[$citat]</h1>";
                    echo "<h3 class='col-sm-12 col-md-12 col-xl-12'>$ljubav[$autor]</h3>";
                }
                elseif($random == 4){
                    echo "<h1 class='col-sm-12 col-md-12 col-xl-12'>$motivacija[$citat3]</h1>";
                    echo "<h3 class='col-sm-12 col-md-12 col-xl-12'>$motivacija[$autor3]</h3>";
                }
                ?>
            </p>
        ...
        <footer class="footer container-fluid fixed-bottom bg-transparent text-light text-right">
            <div>
                <?php
                    $datum = date("d/m/Y");
                    echo "$datum &nbsp";
